...
class AppConfig {
  // ==================== APP IDENTITY ====================
  static const String appName = 'Dadexpress Restaurant';
  static const String appLogoPath = 'assets/images/logo.png';

  // ==================== COLORS & THEME ====================
  static const Color primaryColor = Color(0xFFDDDEDF); // Indigo
  static const Color secondaryColor = Color(0xFFDDDEDF); // Purple
  static const Color accentColor = Color(0xFFDDDEDF); // Pink
  ...
  static const String webUrl = 'https://dadexpress.in/restaurant';
