  ...
  Widget build(BuildContext context) {
    ...
    SystemChrome.setSystemUIOverlayStyle(
      const SystemUiOverlayStyle(
        ...
        systemNavigationBarColor: Color(0xFFDDDEDF), // Dark nav bar
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          Container(
            decoration: const BoxDecoration(color: Color(0xFFDDDEDF)),
          ),
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              ...
                              BoxShadow(
                                color: const Color(0xFFDDDEDF).withOpacity(0.3),
                                blurRadius: 50,
                                spreadRadius: -10,
